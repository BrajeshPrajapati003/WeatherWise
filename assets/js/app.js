/**
 * @license MIT
 * @copyright codewithsadee 2024 All rights reserved
 * @author BrajeshPrajapati <prajapatibrajesh003@gmail.com>
 */
...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    console.log("currentWeather API response: ", currentWeather);
                    ...
                    <div class="card card-sm highlight-card one">
                        ...
                        <div class="wrapper">
                            ...
                            <ul class="card-list">
                                ...
                                <li class="card-item">
                                    <p class="title-1">${Number(o3).toPrecision(
                                      3
                                    )}</p>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecast.list.entries()) {
        if (index > 7) break;
    ...
    <div class="card card-sm slider-card">
      ...
      <p class="body-3">${Math.round(temp)}°C</p>
    </div>
  `;
